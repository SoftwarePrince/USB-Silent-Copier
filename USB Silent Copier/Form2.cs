...
namespace USB_copyer
{
    public partial class Form2 : Form
    {
        ...
        String rsf;
        //form2 is not called anywhere, so not used
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
          try            {
            ...
            var res = MessageBox.Show("Do You Want To Scan Data in "+rl+ "\n\nIf You don't Responce, I will Automatically Start Scanning in 10 sec!", "USB Scanner Antivirus", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
